    ...
    if(isset($_POST["submitButton"])) {
        ...
        $wasSuccesfull = $account->login($username,$password);    
...
<body>
    ...
    <div class="signInContainer">
        ...
        <div class="column">
            ...
            <div class="header">
                <img src="assets/images/icons/ytLogo.jpg" title="logo" alt="Site logo">
                <h3>Sign In</h3>
            ...
            <div class="loginForm">
                ...
                <?php echo $account->getError(Constants::$loginFailed); ?>
                        ...
                        <input type="password" name="password"placeholder="Password"require_once>
