...
class SelectThumbnail {
    ...
    private function getThumbnailData() {
        ...
        $query = $this->con->prepare("SELECT * FROM thumbnails WHERE videoid=:videoid"); // 'videoId' yerine 'videoid'
        $videoId = $this->video->getId();
        $query->bindParam(":videoid", $videoId); // Parametre ismini 'videoid' olarak güncelle
